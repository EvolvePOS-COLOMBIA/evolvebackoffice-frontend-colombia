...
export type Namespace = "common" | "auth" | "platform-dashboard" | "platform-clients" | "platform-tenants" | "business-dashboard" | "business-items" | "business-items-catalog" | "business-inventory" | "business-onboarding" | "business-people" | "business-reports" | "business-registers" | "business-settings" | "business-branches-terminals" | "business-users-catalog" | "marketing"
